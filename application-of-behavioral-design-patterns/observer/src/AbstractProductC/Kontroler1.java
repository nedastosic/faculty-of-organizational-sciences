...
public final class Kontroler1 extends Kontroler{
    ...
    {javax.swing.JButton Kreiraj = ef.getPanel().getKreiraj();
     ...
     javax.swing.JTextField SifraPrijave = ef.getPanel().getSifraIntervencije1(); // Promenljivo!!!
...
boolean zapamtiDomenskiObjekat(){ 
    ...
    if (signal==true) 
        { bbp.commitTransation();
          poruka ="Sistem je zapamtio intervenciju."; 
        }
        else
        { bbp.rollbackTransation();
          poruka ="Sistem ne moze da zapamti intervenciju.";  
        }
    prikaziPoruku();
    bbp.closeConnection();
    return signal; 
